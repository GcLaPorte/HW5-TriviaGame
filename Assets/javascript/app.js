...
var next = ["2","3","4","5","6","7","8","9", "10"]



var counter = 0;

var right = $(".correctAnswer").click(function(){
  
  $('.correctAnswer').val("");
  alert("Correct!");
  counter++;

  document.querySelector("#correctAnswers").innerHTML = counter;
  console.log(counter);
...
var wrong = $(".Answer").click(function(){
...
$(document).ready(function () {
  ...
  var timeUP = setInterval(function () {
    ...
    if (timeLeft == 0) {
      ...
      alert("time's up! you scored: " + counter+"/10");
